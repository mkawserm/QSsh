...
//NOTE removed to reduce dependency
    ...
    EncryptionMode encryptionMode)
{
    ...
    try {
        ...
        m_error = QString("Error generating key: %1").arg(QString::fromLatin1(e.what()));
        return false;
    }
}

void SshKeyGenerator::setPassword(const QString &password)
{
    if(this->m_password!=password) this->m_password = password;
}
